import { geminiModel } from '../config/vertexai.js';

// Analyze issue image and return category, severity, summary
export const analyzeIssueImage = async (imageBase64, mimeType = 'image/jpeg', description = '') => {
    try {
        const prompt = `
...
export const generateInsight = async (issueStats) => {
    try {
        const prompt = `
...
// Original runAISafetyCheck placeholder for backwards compatibility
...
export default { analyzeIssueImage, generateInsight, runAISafetyCheck };
