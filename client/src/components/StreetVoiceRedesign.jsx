...
import { addPropertyControls, ControlType, useIsStaticRenderer } from "./framerMock"
import { AnimatePresence, motion, useInView } from "framer-motion"

const tabs = ["Landing", "Home", "Report Issue", "My Reports", "Dashboard", "Community"]
const defaultBg =
...
function useSharedStyles(props) {
    const { textColor, fontFamily, bodyFont, headingFont, surfaceColor } = props
    const sharedShellStyle = React.useMemo(
        () => ({
...
function renderLandingPage(props, isMobile, shouldAnimate, headingStyle, textBaseStyle) {
    return (
        <section
            style={{
                position: "relative",
...
function renderAppPage(view, isMobile, shouldAnimate, props, sharedShellStyle, textBaseStyle, headingStyle) {
    if (view === "Home") {
...
function AppScaffold({ currentView, props, interactive }) {
 ...
 */
export default function StreetVoiceRedesign(props) {
 ...
 * @framerSupportedLayoutHeight any-prefer-fixed
 */
export function StreetVoiceLandingPage(props) {
 ...
 * @framerSupportedLayoutHeight any-prefer-fixed
 */
export function StreetVoiceHomePage(props) {
 ...
 * @framerSupportedLayoutHeight any-prefer-fixed
 */
export function StreetVoiceReportIssuePage(props) {
 ...
 * @framerSupportedLayoutHeight any-prefer-fixed
 */
export function StreetVoiceMyReportsPage(props) {
 ...
 * @framerSupportedLayoutHeight any-prefer-fixed
 */
export function StreetVoiceDashboardPage(props) {
 ...
 * @framerSupportedLayoutHeight any-prefer-fixed
 */
export function StreetVoiceCommunityPage(props) {
